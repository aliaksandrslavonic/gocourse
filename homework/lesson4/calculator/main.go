...
func ShowHelp() {
	fmt.Printf("Возможные простые операции:\n")
	fmt.Printf(" + \n - \n * \n / \n")
	fmt.Println(" % \n & \n | \n")
	fmt.Printf(" Пример: x+y \n\n")
	fmt.Printf("Возможные функции:\n")
	fmt.Printf(" sqrt Принимает 1 аргумент. Пример sqrt(x)\n")
	fmt.Printf(" abs Принимает 1 аргумент. Пример abs(x)\n")
	fmt.Printf(" log Принимает 2 аргумент. Пример log(x,y)\n")
	fmt.Printf(" ln Принимает 1 аргумент. Пример ln(x)\n")
	fmt.Printf(" sin Принимает 1 аргумент. Пример sin(x)\n")
	fmt.Printf(" cos Принимает 1 аргумент. Пример cos(x)\n")
	fmt.Printf(" tan Принимает 1 аргумент. Пример tan(x)\n")
	fmt.Printf(" arcsin Принимает 1 аргумент. Пример arcsin(x)\n")
	fmt.Printf(" arccos Принимает 1 аргумент. Пример arccos(x)\n")
	fmt.Printf(" arctan Принимает 1 аргумент. Пример arctan(x)\n")
	fmt.Printf(" min Принимает 2 аргумент. Пример min(x,y)\n")
	fmt.Printf(" max Принимает 2 аргумент. Пример max(x,y)\n")
}
